    ...
    s1: [
        ...
        },
        {
            ...
            why: [
                ...
                'Además, los LLM no son completamente <button type="button" class="inline-glossary-link" onclick="openGlossary(&#39;no_determinismo&#39;)">deterministas</button>: dos formulaciones muy parecidas pueden devolver matices distintos. Si la salida cambia mucho, no la uses como desempate; tómala como señal de incertidumbre.',
            ...
            how: [
                ...
                'Si repites la consulta con cambios mínimos y la salida oscila mucho, trátalo como motivo para frenar y verificar',
        ...
        },
        {
            ...
            why: [
                ...
                'Las herramientas con RAG avanzan hacia una <button type="button" class="inline-glossary-link" onclick="openGlossary(&#39;fundamentacion&#39;)">fundamentación verificable</button>: reducen alucinaciones un 12–18% al restringir la respuesta a documentos reales. Pero atención: tener fuentes no equivale a tener buen juicio. La IA coincide con el revisor experto al valorar el riesgo de sesgo menos de 1 de cada 3 veces.',
    ...
    s2: [
        ...
        },
        {
            ...
            why: [
                ...
                'Además, la explicación que ves está mediada por el diseño de la interfaz y por el <button type="button" class="inline-glossary-link" onclick="openGlossary(&#39;prompt_sistema&#39;)">prompt de sistema</button>: no equivale a acceso directo al razonamiento real del modelo.',
    ...
    s3bA: [
        ...
        },
        {
            ...
            why: [
                ...
                'No es lo mismo usar un LLM como bloc de notas que usarlo como <button type="button" class="inline-glossary-link" onclick="openGlossary(&#39;agentica&#39;)">IA agéntica</button> conectada a correo, formularios o agenda. Cuando además lee entradas externas aparece el riesgo de <button type="button" class="inline-glossary-link" onclick="openGlossary(&#39;inyeccion_prompts&#39;)">inyección de prompts</button>: una instrucción oculta en el contenido puede desviar la respuesta o la acción.',
            ...
            how: [
                ...
                'Separa por escrito tres niveles de uso: redactar, analizar documentos y ejecutar acciones. No les des la misma confianza',
    ...
    s3u: [
        {
            ...
            how: [
                'Anota qué herramienta, versión y fecha usaste: el output de un LLM no es plenamente <button type="button" class="inline-glossary-link" onclick="openGlossary(&#39;no_determinismo&#39;)">determinista</button> y puede cambiar tras otra ejecución o una actualización',

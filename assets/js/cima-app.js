...
`;
    ...
    _buildPgxAiPrompt(medName, medAtc, biomList) {
        ...
        return [
            ...
            '   - Empieza con 1–2 frases que expliquen QUÉ ES este biomarcador concreto (función bioquímica básica, papel en el metabolismo o farmacología — en lenguaje clínico práctico, no de biología molecular).',
            ...
            '',
            '5. **Cita la guideline CPIC concreta** con URL (clinpgx.org / cpicpgx.org) o PharmGKB. No inventes URLs.',
            '',
